...
var heart1Img,heart2Img,heart3Img,heart4Img;
var heart1,heart2,heart3,heart4;
...
heart4Img = loadImage("2309168.png")
...
heart4 = createSprite(displayWidth - 150,40 ,20,20);
 heart4.addImage(heart4Img)
 heart4.visible = false
 heart4.scale = 0.2


bullet = createSprite(displayWidth - 800,500 ,20,20)
...
function getZombie(){
  ...
  if(frameCount % 100 === 0){
   ...
   enemy.debug = true
   enemy.setCollider("rectangle",0,0,400,900);
  }
}
